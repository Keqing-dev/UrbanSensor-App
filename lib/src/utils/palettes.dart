...
class Palettes {
  ...
  static const Color _lightBlue = Color.fromRGBO(92, 167, 255, 1);
  static const Color _rose = Color.fromRGBO(255, 131, 131, 1);

  static Color get primary => _primary;

  static Color get gray5 => _gray5;

  static Color get lightBlue => _lightBlue;

  static Color get gray2 => _gray2;

  static Color get gray3 => _gray3;
